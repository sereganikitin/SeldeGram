...
const styles = StyleSheet.create({
  ...
  editHint: { fontSize: 11, color: '#8c6471', textAlign: 'center', marginTop: 2 },
  subtitle: { fontSize: 14, color: '#8c6471', marginTop: 6 },
  slug: { fontSize: 14, color: '#ff7a99', marginTop: 4 },
  ...
  saveBtn: { fontSize: 26, color: '#ff7a99' },
  addBox: { backgroundColor: '#ffe8f0', borderRadius: 12, padding: 12, marginBottom: 8 },
  addInput: { borderWidth: 1, borderColor: '#ffd4e1', borderRadius: 8, padding: 10, marginBottom: 8, backgroundColor: '#fff5f9' },
  addRow: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: '#ffd4e1' },
  memberRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: 10,
  ...
  you: { color: '#ff7a99', fontWeight: '400' },
